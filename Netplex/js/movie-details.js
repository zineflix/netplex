...
const MOVIE_ENDPOINTS = [
  ...
  { url: 'https://embedmaster.link/movie/', name: 'Server 2' },
  { url: 'https://player.cinezo.live/embed/movie/', name: 'Server 3' },
  { url: 'https://fmov.my/embed/movie/', name: 'Server 4' },
  { url: 'https://framextv.tech/embed/', name: 'Server 5' },
  { url: 'https://web.nxsha.app/embed/movie/', name: 'Server 6' },  
  { url: 'https://embed.rahulparkash29.workers.dev/movie/', name: 'Server 7' }, 
  { url: 'https://moviesapi.to/movie/', name: 'Server 8' }, 
  { url: 'https://cinevaro.app/media/tmdb-movie-', name: 'Server 9' },   
  { url: 'https://hexa.su/watch/movie/', name: 'Server 10' }, 
  { url: 'https://vidflix.club/movie/', name: 'Server 11' },
  { url: 'https://vidzen.fun/movie/', name: 'Server 12' },
  { url: 'https://player.vidzee.wtf/embed/movie/', name: 'Server 13' },
  { url: 'https://rivestream.ru/watch?type=movie&id=', name: 'Server 14' }, 
  { url: 'https://vidup.to/movie/', name: 'Server 15 Ads' },
  { url: 'https://vsembed.ru/embed/movie/', name: 'Server 16 Ads' },
  { url: 'https://api.cineby.homes/embed/movie/', name: 'Server 17 Ads' },
  { url: 'https://vidbolt.pro/movie/', name: 'Server 18 Ads' },
  { url: 'https://player.videasy.to/movie/', name: 'Server 19 Ads' },
  { url: 'https://vidcore.io/movie/', name: 'Server 20 Ads' },
  { url: 'https://vaplayer.ru/embed/movie/', name: 'Server 21 Ads' },
  { url: 'https://vidsrc.hair/embed/movie/', name: 'Server 22 Ads' },
  { url: 'https://player.zxcstream.xyz/player/movie/', name: 'Server 23 Ads' },
  { url: 'https://111movies.net/movie/', name: 'Server 24 Ads' },
  { url: 'https://vidrock.net/movie/', name: 'Server 25 Ads' },
];
