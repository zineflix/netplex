...
const TV_ENDPOINTS = [
  ...
  { url: 'https://embedmaster.link/tv/', name: 'Server 2' },
  { url: 'https://player.cinezo.live/embed/tv/', name: 'Server 3' },
  { url: 'https://fmov.my/embed/tv/', name: 'Server 4' },
  { url: 'https://framextv.tech/embed/', name: 'Server 5' },
  { url: 'https://web.nxsha.app/embed/tv/', name: 'Server 6' },  
  { url: 'https://embed.rahulparkash29.workers.dev/tv/', name: 'Server 7' }, 
  { url: 'https://moviesapi.to/tv/', name: 'Server 8' }, 
  { url: 'https://cinevaro.app/media/tmdb-tv-', name: 'Server 9' },   
  { url: 'https://hexa.su/watch/tv/', name: 'Server 10' }, 
  { url: 'https://vidflix.club/tv/', name: 'Server 11' },
  { url: 'https://vidzen.fun/tv/', name: 'Server 12' },
  { url: 'https://player.vidzee.wtf/embed/tv/', name: 'Server 13' },
  { url: 'https://rivestream.ru/watch?type=tv&id=', name: 'Server 14' },
  { url: 'https://vidup.to/tv/', name: 'Server 15 Ads' },
  { url: 'https://vsembed.ru/embed/tv/', name: 'Server 16 Ads' },
  { url: 'https://api.cineby.homes/embed/tv/', name: 'Server 17 Ads' },
  { url: 'https://vidbolt.pro/tv/', name: 'Server 18 Ads' },
  { url: 'https://player.videasy.to/tv/', name: 'Server 19 Ads' },
  { url: 'https://vidcore.io/tv/', name: 'Server 20 Ads' },
  { url: 'https://vaplayer.ru/embed/tv/', name: 'Server 21 Ads' },
  { url: 'https://vidsrc.hair/embed/tv/', name: 'Server 22 Ads' },
  { url: 'https://player.zxcstream.xyz/player/tv/', name: 'Server 23 Ads' },
  { url: 'https://111movies.net/tv/', name: 'Server 24 Ads' },
  { url: 'https://vidrock.net/tv/', name: 'Server 25 Ads' },
];
