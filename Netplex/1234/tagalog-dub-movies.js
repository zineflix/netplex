...
const FPJ_MOVIE_IDS = [
  861421, 515847, 880757, 507653, 359768, 399456, 492887, 533243, 491127, 801546,
  496150, 586724, 954933, 360772, 966196, 767016, 515794, 799393
];

const MOVIE_VIDEOS = {
  18377: "https://ok.ru/videoembed/9633107347995?nochat=1",
  597: "https://ok.ru/videoembed/9644046748238?nochat=1",
  57627: "https://ok.ru/videoembed/9644096817742?nochat=1",
  455714: "https://ok.ru/videoembed/9644110776910?nochat=1",
  9470: "https://short.icu/XoTnMZi8e",
  396535: "https://short.icu/LqFDAWPgr",
  20453: "https://ok.ru/videoembed/9644393499214?nochat=1",
  1001311: "https://ok.ru/videoembed/9644423055950?nochat=1",
  11770: "https://short.icu/9WQZkbpvM",
  41387: "https://short.icu/Vs4-n_xYk",
  16269: "https://ok.ru/videoembed/9644806376014?nochat=1",
  57663: "https://ok.ru/videoembed/9644935875150?nochat=1",
  53658: "https://ok.ru/videoembed/9645021006414?nochat=1",
  570511: "https://ok.ru/videoembed/9645632719438?nochat=1",
  200085: "https://ok.ru/videoembed/9648220408398?nochat=1",
  433945: "https://short.icu/isDXfa25J",
  184219: "https://ok.ru/videoembed/9653891828302?nochat=1",
  11178: "https://ok.ru/videoembed/9663357454926?nochat=1",
  15859: "https://ok.ru/videoembed/9663417485902?nochat=1",
  158445: "https://short.icu/38tub1wQA",
  851644: "https://ok.ru/videoembed/9668446128718?nochat=1",
  9056: "https://ok.ru/videoembed/9671771294286?nochat=1",
  10753: "https://ok.ru/videoembed/9671802948174?nochat=1",
  11134: "https://short.icu/mAo8J7sVwG",
  9404: "https://ok.ru/videoembed/9671888276046?nochat=1",
  11636: "https://short.icu/b4IONWrDS",
  52324: "https://ok.ru/videoembed/9671939918414?nochat=1",
  58233: "https://ok.ru/videoembed/9643975313998?nochat=1",
  ...
  76826: "https://ok.ru/videoembed/11124806453787?nochat=1",

  // FPJ Collection mapped globally upfront
  ...
  399456: "https://drive.google.com/file/d/1p9vsWKd77pZSQgr9P-ftcbIOBzi6bd4O/preview",
  492887: "https://drive.google.com/file/d/13-wl6fLnitp5hAKJ4dxyqGuLUqmqFGhU/preview",
  533243: "https://drive.google.com/file/d/1vFDJ93KGNHrGj_Ng4i8vsYPi0wDDlvJP/preview",
  491127: "https://drive.google.com/file/d/1XBdp1g-4_vS0KLIGek2JvEE-8MzpCmmV/preview",
  801546: "https://drive.google.com/file/d/1z212RcbZpqovqr3TZPWMjbUkmFoidpRe/preview",
  496150: "https://drive.google.com/file/d/1KS3ChKEmrUzun3c0N7XwgAUdBHyPGe-l/preview",
  586724: "https://drive.google.com/file/d/1EQZX8S2RWJvjtqULBOe8jxZSZauWDE7R/preview",
  954933: "https://drive.google.com/file/d/1qGaGaXPbYtkSLSox0MEeJuxZrVbwrS0H/preview",
  360772: "https://drive.google.com/file/d/1r7tqQaBgCTJyNT9k6EHHI2GS5yNxpVUG/preview",
  966196: "https://drive.google.com/file/d/1l72uIppz_2wpVthmGq8m8QKqn8RjOcNZ/preview",
  767016: "https://drive.google.com/file/d/1PP6FXWGqV_PJs8KFCP_bsWbYBfachVuV/preview",
  515794: "https://drive.google.com/file/d/1BZ6GsIxpZyxYnORlPjlvPKUx2MIfo3I-/preview",
  799393: "https://drive.google.com/file/d/1HTa8HodERJx4bz2JhMdIaLU9Qg0QHZRO/preview"
};

// --- TV Show Configuration & Links ---
const TV_SHOW_IDS = [
...
const TV_EPISODES = {
  219246: {
    ...
    titles: [
      ...
      "Season 1 Episode 4", "Season 1 Episode 5", "Season 1 Episode 6",
      "Season 1 Episode 7", "Season 1 Episode 8", "Season 1 Episode 9 to 12"
    ]
  },
  135238: {
    links: [
    ...
    titles: [
      ...
      "Season 2 Episode 3", "Season 2 Episode 4", "Season 2 Episode 5", "Season 2 Episode 6",
      "Season 2 Episode 7"
    ]
  },
  117378: {
    ...
    titles: Array.from({ length: 20 }, (_, i) => `Season 1 Episode ${i + 1}`)
  },
  43899: {
    links: [
    ...
    titles: Array.from({ length: 10 }, (_, i) => `Episode ${i + 1}`)
  },
  68814: {
    links: [
    ...
    titles: Array.from({ length: 16 }, (_, i) => `Episode ${i + 1}`)
  },
  119051: {
    links: [
  ...
  66776: {
    ...
    titles: Array.from({ length: 30 }, (_, i) => `Season 1 Episode ${i + 1}`)
  },
  255779: {
    links: [
    ...
    titles: Array.from({ length: 10 }, (_, i) => `Season 1 Episode ${i + 1}`)
  },
  112836: {
    links: [
    ...
    titles: Array.from({ length: 6 }, (_, i) => `Episode ${i + 1}`)
  },
  99966: {
    links: [
    ...
    titles: Array.from({ length: 12 }, (_, i) => `Season 1 Episode ${i + 1}`)
  },
  76557: {
    links: [
    ...
    titles: [
      ...Array.from({ length: 20 }, (_, i) => `Season 1 Episode ${i + 1}`),
      ...Array.from({ length: 16 }, (_, i) => `Season 2 Episode ${i + 1}`)
    ]
  }
};
...
function openModal(movie) {
  if (!movieModal || !movieTrailer) return;

  if (moviePoster) {
    moviePoster.src = movie.poster_path ? `${IMAGE_BASE_URL}${movie.poster_path}` : "";
    moviePoster.alt = movie.title || "Movie Poster";
  }
  if (movieTitle) movieTitle.textContent = movie.title || "Untitled";
  if (movieGenres) {
    movieGenres.textContent = movie.genres ? movie.genres.map(g => g.name).join(", ") : "Unknown";
  }
  if (movieDescription) {
    movieDescription.textContent = movie.overview || "No description available.";
  }

  // Look up source from MOVIE_VIDEOS (includes FPJ videos)
  const videoUrl = MOVIE_VIDEOS[movie.id];
  movieTrailer.src = videoUrl ? videoUrl.trim() : "https://www.youtube.com/embed/defaultVideo";
...
function openTvModal(show) {
  if (!tvModal || !tvTrailer || !episodeDropdown) return;

  if (tvPoster) {
    tvPoster.src = show.poster_path ? `${IMAGE_BASE_URL}${show.poster_path}` : "";
    tvPoster.alt = show.name || "TV Poster";
  }
  if (tvTitle) tvTitle.textContent = show.name || "Untitled";
  if (tvDescription) {
  ...
  if (episodesInfo && episodesInfo.links && episodesInfo.links.length > 0) {
    episodesInfo.links.forEach((link, index) => {
      const option = document.createElement("option");
      option.value = link.trim();
      option.textContent = episodesInfo.titles?.[index] || `Episode ${index + 1}`;
      episodeDropdown.appendChild(option);
    });

    tvTrailer.src = episodesInfo.links[0].trim();
...
async function fetchMovies() {
  ...
  try {
    ...
    console.error("Error loading Tagalog Dub movies:", error);
...
async function fetchTvShows() {
  ...
  try {
    ...
    const tvRequests = TV_SHOW_IDS.map(id =>
      fetch(`https://api.themoviedb.org/3/tv/${id}?api_key=${API_KEY}`).then(res => res.json())
    );
...
// --- Global Modal Close & Keydown Listeners ---
...
// --- Fullscreen Helpers ---
function requestElementFullscreen(iframe) {
  if (!iframe) return;
...
if (fullscreenBtn) {
  fullscreenBtn.addEventListener("click", () => requestElementFullscreen(movieTrailer));
}

const tvFullscreenBtn = document.getElementById("tvFullscreenButton");
if (tvFullscreenBtn) {
  tvFullscreenBtn.addEventListener("click", () => requestElementFullscreen(tvTrailer));
}
